    ...
    public static abstract class Stub extends Binder implements IDualScreenCallbacks {
        ...
        private static class Proxy implements IDualScreenCallbacks {
            ...
            public String getInterfaceDescriptor() {
                return "com.samsung.android.multidisplay.dualscreen.IDualScreenCallbacks";
            }
            ...
            public void screenFocusChanged(DualScreen focusedScreen) throws RemoteException {
                ...
                try {
                    _data.writeInterfaceToken("com.samsung.android.multidisplay.dualscreen.IDualScreenCallbacks");
        ...
        public Stub() {
            attachInterface(this, "com.samsung.android.multidisplay.dualscreen.IDualScreenCallbacks");
        }
        ...
        public static IDualScreenCallbacks asInterface(IBinder obj) {
            ...
            IInterface iin = obj.queryLocalInterface("com.samsung.android.multidisplay.dualscreen.IDualScreenCallbacks");
        ...
        public boolean onTransact(int code, Parcel data, Parcel reply, int flags) throws RemoteException {
            switch (code) {
                case 1:
                    DualScreen _arg0;
                    data.enforceInterface("com.samsung.android.multidisplay.dualscreen.IDualScreenCallbacks");
                    if (data.readInt() != 0) {
                    ...
                    return true;
                case 1598968902:
                    reply.writeString("com.samsung.android.multidisplay.dualscreen.IDualScreenCallbacks");
                    return true;
                default:
