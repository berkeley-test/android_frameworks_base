...
public class DualScreenManager {
    ...
    public static android.content.Intent makeIntent(android.content.Context r8, android.content.Intent r9, com.samsung.android.dualscreen.DualScreen r10, int r11) {
        /*
    ...
    L_0x0053:
        r4 = new java.lang.IllegalArgumentException;
        r5 = "targetScreen is null";
        r4.<init>(r5);
        throw r4;
    L_0x005c:
        r4 = com.samsung.android.multidisplay.dualscreen.DualScreenUtils.hasCoupledTaskFlags(r11);
        if (r4 == 0) goto L_0x006e;
    L_0x0062:
        r4 = r8 instanceof android.app.Activity;
        if (r4 != 0) goto L_0x006e;
    L_0x0066:
        r4 = new java.lang.IllegalArgumentException;
        r5 = "context should be Activity to use FLAG_COUPLED_TASK_XXX flags";
        r4.<init>(r5);
        throw r4;
    L_0x006e:
        r4 = r8 instanceof android.app.Activity;
    ...
    L_0x0072:
        ...
        r3 = r0.getActivityToken();
        if (r3 != 0) goto L_0x0083;
    L_0x007b:
        r4 = new java.lang.IllegalArgumentException;
        r5 = "invalid activity token";
        r4.<init>(r5);
        throw r4;
    L_0x0083:
        r1 = 1;
        r4 = getDefault();	 Catch:{ RemoteException -> 0x00a0 }
        r1 = r4.canBeCoupled(r3);	 Catch:{ RemoteException -> 0x00a0 }
        r4 = com.samsung.android.multidisplay.dualscreen.DualScreenUtils.hasCoupledTaskFlags(r11);
        if (r4 == 0) goto L_0x00a5;
    L_0x0092:
        if (r1 != 0) goto L_0x00a5;
    L_0x0094:
        r4 = r9.getLaunchParams();
        r5 = com.samsung.android.multidisplay.dualscreen.DualScreenUtils.getCoupledTaskFlags();
        r4.clearFlags(r5);
    L_0x009f:
        return r9;
    L_0x00a0:
    ...
    L_0x00e4:
        ...
        r5 = new java.lang.StringBuilder;
        r5.<init>();
        r6 = "makeIntent called from non-Activity context; forcing Intent.FLAG_ACTIVITY_NEW_TASK for: ";
        r5 = r5.append(r6);
        r5 = r5.append(r9);
        r5 = r5.toString();
        android.util.Log.d(r4, r5);
        ...
        goto L_0x00b8;
        */
        throw new UnsupportedOperationException("Method not decompiled: com.samsung.android.dualscreen.DualScreenManager.makeIntent(android.content.Context, android.content.Intent, com.samsung.android.dualscreen.DualScreen, int):android.content.Intent");
    }
    ...
    public static void parseDualScreenLaunchParams(Context context, Intent intent) {
        if (intent != null) {
            ...
            if (b != null && context != null) {
                ...
                String screen = b.getString("dualscreen:screen");
                ...
                if (context instanceof Activity) {
                    ...
                    if (((Activity) context).getActivityToken() != null) {
                        Boolean coupled = Boolean.valueOf(b.getBoolean("dualscreen:coupled"));
                        if (DEBUG) {
