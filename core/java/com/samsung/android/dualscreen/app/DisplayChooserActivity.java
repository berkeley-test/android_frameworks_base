...
public class DisplayChooserActivity extends AlertActivity implements OnItemClickListener {
    ...
    private final class DisplayListAdapter extends BaseAdapter {
        ...
        private void rebuildList() {
            ...
            for (int displayId : dm.getDisplayIds()) {
                if (isActionMain || DualScreenUtils.displayIdToScreen(displayId) != DualScreen.FULL) {
                    ...
                    Log.d("DisplayChooserActivity", "rebuildList() : displayId=" + displayId + " : display=" + display);
                    if (display != null) {
                        displayName = display.getName();
                    } else {
                        displayName = new String("display[" + Integer.toString(displayId) + "]");
                    }
                    Log.d("DisplayChooserActivity", "rebuildList() : displayName=" + displayName);
                    switch (displayId) {
                        case 0:
        ...
        public Intent intentForPosition(int position) {
            ...
            Log.d("DisplayChooserActivity", "resolveInfoForPosition() : mCallerDisplayId=" + this.mCallerDisplayId + " targetDisplayId=" + dri.displayId);
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            View view;
            if (convertView == null) {
                view = this.mInflater.inflate(17367142, parent, false);
                LayoutParams lp = ((ImageView) view.findViewById(16908294)).getLayoutParams();
        ...
        private final void bindView(View view, DisplayResolveInfo info) {
            ...
            ((TextView) view.findViewById(16908308)).setText(info.displayLabel);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        onCreate(savedInstanceState, makeMyIntent(), getResources().getText(17040221), null, null, true);
    }
    ...
    protected void onCreate(Bundle savedInstanceState, Intent intent, CharSequence title, Intent[] initialIntents, List<ResolveInfo> list, boolean alwaysUseOption) {
        ...
        Log.d("DisplayChooserActivity", "onCreate() : rInfo=" + rInfo);
        Log.d("DisplayChooserActivity", "onCreate() : callerDisplayId=" + callerDisplayId);
        this.mAdapter = new DisplayListAdapter(this, intent, rInfo, this.mLaunchedFromUid, callerDisplayId);
        ap.mView = getLayoutInflater().inflate(17367141, null);
        this.mGrid = (GridView) ap.mView.findViewById(16909231);
    ...
    /*Drawable loadIconForResolveInfo(ResolveInfo ri) {
        try {
            ...
            Log.e("DisplayChooserActivity", "Couldn't find resources for package", e);
        }
    }*/
    ...
    protected void onIntentSelected(ResolveInfo ri, Intent intent) {
        if (intent != null) {
            try {
                ...
                Log.w("DisplayChooserActivity", "Activity Not Found");
            }
        }
    }
}
