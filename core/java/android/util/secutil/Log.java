...
public final class Log {
    ...
    public interface TerribleFailureHandler {
        void onTerribleFailure(String str, TerribleFailure terribleFailure, boolean system);
    }
    ...
    public static int v(String tag, String msg, Throwable tr) {
        if (LogSwitcher.isShowingGlobalLog) {
            return println_native(0, 2, tag, msg + 10 + getStackTraceString(tr));
        }
        return 0;
    }
    ...
    public static int d(String tag, String msg, Throwable tr) {
        if (LogSwitcher.isShowingGlobalLog) {
            return println_native(0, 3, tag, msg + 10 + getStackTraceString(tr));
        }
        return 0;
    }
    ...
    public static int i(String tag, String msg, Throwable tr) {
        if (LogSwitcher.isShowingGlobalLog) {
            return println_native(0, 4, tag, msg + 10 + getStackTraceString(tr));
        }
        return 0;
    }
    ...
    public static int w(String tag, String msg, Throwable tr) {
        if (LogSwitcher.isShowingGlobalLog) {
            return println_native(0, 5, tag, msg + 10 + getStackTraceString(tr));
        }
        return 0;
    }
    ...
    public static int e(String tag, String msg, Throwable tr) {
        if (LogSwitcher.isShowingGlobalLog) {
            return println_native(0, 6, tag, msg + 10 + getStackTraceString(tr));
        }
        return 0;
    }
